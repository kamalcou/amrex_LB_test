...
./main3d.gnu.x86-milan.TPROF.OMP.ex inputs  nbins=2 max_grid_size="(128,128,64)" >output/2_16_output_.$SLURM_JOBID.txt
# ./main3d.gnu.x86-milan.TPROF.ex inputs  nbins=2 max_grid_size="(128,64,64)" >output/2_32_output.txt
./main3d.gnu.x86-milan.TPROF.OMP.ex inputs  nbins=2 max_grid_size="(64,64,64)" >output/2_64_output_.$SLURM_JOBID.txt
