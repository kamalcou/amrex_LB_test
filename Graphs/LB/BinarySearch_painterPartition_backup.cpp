...
bool isPartitionPossible(vector<long long> arr, int n, int k, long long maxTime){
...
long long minTime(vector<long long> arr, int n, int k)
    {
        // code here
        // return minimum time
